...
static const char* const yytname[] = {
    "$end",       "error",       "$undefined",
    "DQUOTED",    "REGEXP",      "LIDENT",
    "UIDENT",     "QIDENT",      "ARROW",
    "KW_MODULE",  "KW_AUTOLOAD", "KW_LET",
    "KW_LET_REC", "KW_IN",       "KW_STRING",
    "KW_REGEXP",  "KW_LENS",     "KW_TEST",
    "KW_GET",     "KW_PUT",      "KW_AFTER",
    "'='",        "'?'",         "'*'",
    "';'",        "'|'",         "'-'",
    "'.'",        "'('",         "')'",
    "'['",        "']'",         "'+'",
    "':'",        "'{'",         "'}'",
    "$accept",    "start",       "autoload",
    "decls",      "test_exp",    "test_special_res",
    "exp",        "composeexp",  "unionexp",
    "minusexp",   "catexp",      "appexp",
    "aexp",       "rexp",        "rep",
    "qid",        "param_list",  "param",
    "id",         "type",        "atype",
    "tree_const", "tree_const2", "tree_branch",
...
#line 180 "parser.y" /* yacc.c:1646  */
  {
    (*term) = make_module(
        (yyvsp[-3].string), (yyvsp[-1].string), (yyvsp[0].term), &(yylsp[-4]));
  }
...
#line 188 "parser.y" /* yacc.c:1646  */
  {
    ...
    (yyval.term) = make_bind((yyvsp[-4].string),
                             (yyvsp[-3].term),
                             (yyvsp[-1].term),
                             (yyvsp[0].term),
                             &(yylsp[-5]));
...
#line 193 "parser.y" /* yacc.c:1646  */
  {
    ...
    (yyval.term) = make_bind_rec(
        (yyvsp[-3].string), (yyvsp[-1].term), (yyvsp[0].term), &(yylsp[-4]));
  }
...
#line 198 "parser.y" /* yacc.c:1646  */
  {
    LOC_MERGE((yylsp[-4]), (yylsp[-4]), (yylsp[-1]));
    (yyval.term) = make_test((yyvsp[-3].term),
                             (yyvsp[-1].term),
                             TR_CHECK,
                             (yyvsp[0].term),
                             &(yylsp[-4]));
...
#line 215 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) = make_put_test(
        (yyvsp[-4].term), (yyvsp[-2].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 224 "parser.y" /* yacc.c:1646  */
  {
    ...
    (yyval.term) = make_let((yyvsp[-5].string),
                            (yyvsp[-4].term),
                            (yyvsp[-2].term),
                            (yyvsp[0].term),
                            &(yylsp[-6]));
...
#line 231 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) =
        make_binop(A_COMPOSE, (yyvsp[-2].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 236 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) =
        make_binop(A_UNION, (yyvsp[-2].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 243 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) =
        make_binop(A_MINUS, (yyvsp[-2].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 248 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) =
        make_binop(A_CONCAT, (yyvsp[-2].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 253 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) =
        make_binop(A_APP, (yyvsp[-1].term), (yyvsp[0].term), &(yyloc));
  }
...
#line 262 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) = make_regexp_term(
        (yyvsp[0].regexp).pattern, (yyvsp[0].regexp).nocase, &(yylsp[0]));
  }
...
#line 292 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) = (yyvsp[0].term);
    list_cons((yyval.term), (yyvsp[-1].term));
  }
...
#line 297 "parser.y" /* yacc.c:1646  */
  {
    (yyval.term) = make_param(
        (yyvsp[-3].string), (yyvsp[-1].type), clone_info(&(yylsp[-4])));
  }
...
#line 337 "parser.y" /* yacc.c:1646  */
  {
    (yyval.tree) = make_tree(
        (yyvsp[-3].string), (yyvsp[-1].string), NULL, (yyvsp[0].tree));
  }
