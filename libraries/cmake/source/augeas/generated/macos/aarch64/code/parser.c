...
/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {0,  2,  7,  12, 23, 71, 33, 34, 35,
...
#define YY_SYMBOL_PRINT(Title, Kind, Value, Location)                          \
  do {                                                                         \
    if (yydebug) {                                                             \
      ...
      yy_symbol_print(stderr, Kind, Value, Location, term, scanner);           \
      YYFPRINTF(stderr, "\n");                                                 \
    }                                                                          \
  } while (0)
  ...
  */
  if (yyctx->yytoken != YYSYMBOL_YYEMPTY) {
    ...
    yyn = yypcontext_expected_tokens(
        yyctx, yyarg ? yyarg + 1 : yyarg, yyargn - 1);
    if (yyn == YYENOMEM)
      return YYENOMEM;
    else
      yycount += yyn;
