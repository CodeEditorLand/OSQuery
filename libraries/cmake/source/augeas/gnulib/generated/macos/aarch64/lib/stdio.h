...
#pragma GCC system_header
    ...
    defined _GL_ALREADY_INCLUDING_STDIO_H
...
/* But in any case avoid namespace pollution on glibc systems.  */
    ...
    (defined __sun || defined __NetBSD__) && !defined __GLIBC__
#include <unistd.h>
#endif
...
#if (0 < __USE_FORTIFY_LEVEL && __GLIBC__ == 2 && 4 <= __GLIBC_MINOR__ &&      \
     __GLIBC_MINOR__ <= 15 && 3 < __GNUC__ + (4 <= __GNUC_MINOR__) &&          \
     !defined __cplusplus)
#undef fwrite
#undef fwrite_unlocked
extern size_t __REDIRECT(
    rpl_fwrite,
...
#endif
_GL_FUNCDECL_RPL(getdelim,
                 ssize_t,
                 (char** lineptr, size_t* linesize, int delimiter, FILE* stream)
...
#endif
_GL_FUNCDECL_RPL(getline,
                 ssize_t,
                 (char** lineptr,
                  size_t* linesize,
                  FILE* stream)_GL_ARG_NONNULL((1, 2, 3)));
_GL_CXXALIAS_RPL(getline,
                 ssize_t,
                 (char** lineptr, size_t* linesize, FILE* stream));
#else
#if !1
_GL_FUNCDECL_SYS(getline,
                 ssize_t,
                 (char** lineptr,
                  size_t* linesize,
                  FILE* stream)_GL_ARG_NONNULL((1, 2, 3)));
#endif
_GL_CXXALIAS_SYS(getline,
                 ssize_t,
                 (char** lineptr, size_t* linesize, FILE* stream));
#endif
#if 1
...
#else
#if !1
_GL_FUNCDECL_SYS(asprintf,
                 int,
                 (char** result, const char* format, ...)
                     _GL_ATTRIBUTE_FORMAT_PRINTF(2, 3) _GL_ARG_NONNULL((1, 2)));
#endif
_GL_CXXALIAS_SYS(asprintf, int, (char** result, const char* format, ...));
#endif
...
#else
#if !1
_GL_FUNCDECL_SYS(vasprintf,
                 int,
                 (char** result, const char* format, va_list args)
                     _GL_ATTRIBUTE_FORMAT_PRINTF(2, 0) _GL_ARG_NONNULL((1, 2)));
#endif
_GL_CXXALIAS_SYS(vasprintf,
                 int,
                 (char** result, const char* format, va_list args));
#endif
