...
extern error_t argz_create(char* const __argv[],
                           char** restrict __argz,
...
extern void argz_extract(const char* restrict __argz,
                         size_t __len,
...
extern char* argz_next(const char* restrict __argz,
                       size_t __argz_len,
                       const char* restrict __entry);

#ifdef __USE_EXTERN_INLINES
__extern_inline char* __NTH(argz_next(const char* __argz,
                                      size_t __argz_len,
                                      const char* __entry)) {
  if (__entry) {
