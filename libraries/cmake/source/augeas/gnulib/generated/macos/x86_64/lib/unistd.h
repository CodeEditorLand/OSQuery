...
#if 0 && 0 && !defined _GL_INCLUDING_WINSOCK2_H
...
/* But avoid namespace pollution on glibc systems.  */
     ...
     ((0 || defined GNULIB_POSIXCHECK) && defined __CYGWIN__)) &&              \
    !defined __GLIBC__
#include <stdio.h>
#endif
...
#if ((0 || IN_AUGEAS_GNULIB_TESTS || 0 || defined GNULIB_POSIXCHECK) &&        \
     (defined _WIN32 && !defined __CYGWIN__))
#include <direct.h> /* mingw64, MSVC 9 */
#include <io.h> /* mingw32, mingw64 */
#elif (IN_AUGEAS_GNULIB_TESTS || 0 || IN_AUGEAS_GNULIB_TESTS || 0 || 0 || 0 || \
...
/* But avoid namespace pollution on glibc systems.  */
#if ((0 && (defined _AIX || defined __osf__)) || (0 && defined __TANDEM)) &&   \
    !defined __GLIBC__
#include <netdb.h>
#endif
...
#if (0 || 0 || 1 || 0 || 0 || 0 || defined GNULIB_POSIXCHECK)
/* Get ssize_t.  */
#include <sys/types.h>
#endif
...
#elif defined GNULIB_POSIXCHECK
#if HAVE_RAW_DECL_ENVIRON
_GL_UNISTD_INLINE char*** _GL_WARN_ON_USE_ATTRIBUTE(
    "environ is unportable - "
    "use gnulib module environ for portability") rpl_environ(void) {
  return &environ;
}
#undef environ
#define environ (*rpl_environ())
...
_GL_UNISTD_INLINE int getpagesize() {
...
#endif
_GL_FUNCDECL_RPL(readlink,
                 ssize_t,
                 (const char* file,
                  char* buf,
                  size_t bufsize)_GL_ARG_NONNULL((1, 2)));
_GL_CXXALIAS_RPL(readlink,
                 ssize_t,
                 (const char* file, char* buf, size_t bufsize));
#else
#if !1
_GL_FUNCDECL_SYS(readlink,
                 ssize_t,
                 (const char* file,
                  char* buf,
                  size_t bufsize)_GL_ARG_NONNULL((1, 2)));
...
#endif
_GL_FUNCDECL_RPL(symlink,
                 int,
                 (char const* contents,
                  char const* file)_GL_ARG_NONNULL((1, 2)));
_GL_CXXALIAS_RPL(symlink, int, (char const* contents, char const* file));
#else
#if !1
_GL_FUNCDECL_SYS(symlink,
                 int,
                 (char const* contents,
                  char const* file)_GL_ARG_NONNULL((1, 2)));
#endif
