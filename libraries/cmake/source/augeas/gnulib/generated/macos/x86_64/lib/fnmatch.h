...
#endif
_GL_FUNCDECL_RPL(fnmatch,
                 int,
                 (const char* pattern,
                  const char* name,
                  int flags)_GL_ARG_NONNULL((1, 2)));
_GL_CXXALIAS_RPL(fnmatch,
                 int,
                 (const char* pattern, const char* name, int flags));
#else
#if !1
_GL_FUNCDECL_SYS(fnmatch,
                 int,
                 (const char* pattern,
                  const char* name,
                  int flags)_GL_ARG_NONNULL((1, 2)));
#endif
_GL_CXXALIAS_SYS(fnmatch,
                 int,
                 (const char* pattern, const char* name, int flags));
#endif
...
_GL_WARN_ON_USE(fnmatch,
                ...
                "use gnulib module fnmatch for portability or gnulib module "
                "fnmatch-gnu for a glibc compatible implementation");
#endif
#endif
