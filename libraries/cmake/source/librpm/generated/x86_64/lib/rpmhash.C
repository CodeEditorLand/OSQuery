 ...
 */
static Bucket HASHPREFIX(findEntry)(HASHTYPE ht,
                                    HTKEYTYPE key,
...
void HASHPREFIX(AddHEntry)(HASHTYPE ht,
                           HTKEYTYPE key,
                           unsigned int keyHash
#ifdef HTDATATYPE
                           ,
...
void HASHPREFIX(AddEntry)(HASHTYPE ht,
                          HTKEYTYPE key
#ifdef HTDATATYPE
                          ,
                          HTDATATYPE data
...
int HASHPREFIX(HasHEntry)(HASHTYPE ht, HTKEYTYPE key, unsigned int keyHash) {
  ...
  if (!(b = HASHPREFIX(findEntry)(ht, key, keyHash)))
    return 0;
  else
    return 1;
}
...
int HASHPREFIX(GetHEntry)(HASHTYPE ht,
                          HTKEYTYPE key,
                          unsigned int keyHash,
#ifdef HTDATATYPE
                          HTDATATYPE** data,
...
int HASHPREFIX(GetEntry)(HASHTYPE ht,
                         HTKEYTYPE key,
#ifdef HTDATATYPE
                         HTDATATYPE** data,
                         int* dataCount,
#endif
                         HTKEYTYPE* tableKey) {
  return HASHPREFIX(GetHEntry)(ht,
                               key,
                               ht->fn(key),
#ifdef HTDATATYPE
                               data,
