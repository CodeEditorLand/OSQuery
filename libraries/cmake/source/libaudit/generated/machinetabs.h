...
static const char machine_strings[] =
    "aarch64\0arm\0armeb\0armv5tejl\0armv5tel\0armv6l\0armv7l\0i386\0i486\0i586"
    "\0"
...
static int machine_s2i(const char* s, int* value) {
  ...
  len = strlen(s);
  {
    ...
    copy[i] = 0;
    return s2i__(
        machine_strings, machine_s2i_s, machine_s2i_i, 18, copy, value);
  }
}
